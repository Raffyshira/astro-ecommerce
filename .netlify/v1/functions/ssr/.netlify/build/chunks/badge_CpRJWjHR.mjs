import { c as createComponent, r as renderTemplate, a as renderComponent, b as createAstro, d as addAttribute, e as renderHead, f as renderSlot, m as maybeRenderHead } from './astro/server_APlSdSn6.mjs';
import 'kleur/colors';
import 'html-escaper';
/* empty css                         */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html class="scroll-smooth" lang="en"> <head><title>${title || SITE_TITLE}</title><meta charset="UTF-8"><meta name="description"${addAttribute(description || SITE_DESCRIPTION, "content")}><meta name="viewport" content="width=device-width"><meta name="robots" content="index, follow"><meta name="googlebot" content="index, follow"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="canonical"${addAttribute(canonicalURL, "href")}><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta property="og:type" content="website"><meta property="og:title"${addAttribute(title || SITE_TITLE, "content")}><meta property="og:description"${addAttribute(description || SITE_DESCRIPTION, "content")}><meta property="og:url"${addAttribute(Astro2.url, "content")}><meta property="og:image"${addAttribute(Astro2.site + "favicon.svg", "content")}><meta property="og:locale" content="id"><meta property="twitter:card" content="summary"><meta property="twitter:url"${addAttribute(X_ACCOUNT, "content")}><meta property="twitter:title"${addAttribute(title || SITE_TITLE, "content")}><meta property="twitter:description"${addAttribute(description || SITE_DESCRIPTION, "content")}><meta property="twitter:image"${addAttribute(Astro2.site + "favicon.svg", "content")}>${renderHead()}</head> <body> ${renderComponent($$result, "MainHeader", $$MainHeader, {})} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Toaster", Toaster, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/ui/toaster", "client:component-export": "Toaster" })} </body></html>`;
...
export { $$Container as $, Badge as B, Button as a, $$Layout as b, useToast as c, cn as d, useSearchStore as e, useCartStore as u };

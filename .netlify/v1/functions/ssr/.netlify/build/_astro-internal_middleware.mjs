...
import { a as authAsyncStorage } from "./chunks/async-local-storage.server_DC-z4u9b.mjs";
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_d29ya2FibGUtY29sbGllLTU5LmNsZXJrLmFjY291bnRzLmRldiQ", "SITE": "http://localhost:4321/", "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_H8ZlMnWRhkwkstkaX4enuvtZZ6NF9sOhpZcrO1KcBP", _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"1.4.1"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "1.4.1",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_H8ZlMnWRhkwkstkaX4enuvtZZ6NF9sOhpZcrO1KcBP", _: process.env._ }).MODE
  },
  telemetry: {

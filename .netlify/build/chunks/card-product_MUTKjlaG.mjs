...
import { d as cn, a as Button, B as Badge } from './badge_CpRJWjHR.mjs';
import useEmblaCarousel from 'embla-carousel-react';
import { ArrowLeft, ArrowRight, MoveLeft, MoveRight, Star } from 'lucide-react';
import { C as Card, a as CardContent, b as CardFooter } from './card_yZwKObQ8.mjs';

const API_BASE_URL = "https://dummyjson.com/products";
async function getAllProducts(offset = 0, limit = 15) {
...
const CardProduct = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Card, { className: "max-w-sm shadow-none w-50 h-full border-none overflow-hidden shrink-0", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "p-3", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-base mt-2 font-semibold", children: name }),
...
export { CardProduct as C, ProductCarousel as P, TestCarousel as T, getRelatedProducts as a, getAllProducts as b, getProductByCategory as c, getProductById as g };
